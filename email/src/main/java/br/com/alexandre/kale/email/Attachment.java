...
public class Attachment implements Serializable {
    ...
    public String toString() {
        return "Attachment [source=" + source + ", mimeType=" + mimeType + ", fileName=" + fileName + "]";
    }

    public static List<Attachment> from(final InputStream inputStream, final String mimeType, final String fileName) {
