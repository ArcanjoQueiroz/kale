...
public class MailSender {
  ...
  public void send(
        ...
        Session.getInstance(
            ...
            new javax.mail.Authenticator() {
              protected PasswordAuthentication getPasswordAuthentication() {
                logger.debug(
                    "Authenticating using: '{}' and properties are '{}'", username, properties);
    ...
    try {
      ...
      bodyPart.setContent(
          Strings.nullToEmpty(html), String.format("text/html; charset=%s", charset));
      ...
      attachments.forEach(
          a -> {
            try {
              ...
              att.setDataHandler(
                  new DataHandler(new ByteArrayDataSource(a.getSource(), a.getMimeType())));
              att.setFileName(StringUtils.stripAccents(a.getFileName()));
              logger.debug(
                  "Adding attachment '{}' into the message with mime type: '{}'",
                  a.getFileName(),
                  a.getMimeType());
