...
public class XlsWriterTest {
  ...
  public void shouldCreateAfileWithOneLine() throws IOException {
    final File file = new File(String.format("./target/file-%s-one-line.xls", new SimpleDateFormat("ddMMyyyyhhmmss").format(new Date())));
  ...
  public void shouldCreateAfileWithManyLines() throws IOException {
    final File file = new File(String.format("./target/file-%s-many-lines.xls", new SimpleDateFormat("ddMMyyyyhhmmss").format(new Date())));
    assertFalse(file.exists());
  ...
  public void shouldUseLocalDate() throws IOException {
    final File file = new File(String.format("./target/file-%s-localdate.xls", new SimpleDateFormat("ddMMyyyyhhmmss").format(new Date())));
    assertFalse(file.exists());
